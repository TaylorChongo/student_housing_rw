...
const Chat = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)] md:h-[calc(100vh-4.5rem)] max-w-4xl mx-auto">
      <div className="flex-1 flex flex-col bg-white border md:m-4 md:rounded-3xl shadow-xl overflow-hidden">
        <div className="bg-emerald-600 p-4 text-white flex items-center gap-4 shrink-0">
          <button 
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-bold text-lg leading-none">{otherUser?.name || 'Loading...'}</h2>
        ...
        <form onSubmit={handleSend} className="p-4 bg-white border-t flex gap-3 items-center shrink-0">
          <input 
            type="text" 
            value={content} 
            onChange={e => setContent(e.target.value)} 
            className="flex-1 bg-gray-100 border-none rounded-2xl px-5 py-3 focus:ring-2 focus:ring-emerald-600 outline-none transition-all font-medium" 
