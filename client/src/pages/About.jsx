    ...
    <div className="pb-24">
      ...
      <section className="py-24 px-6 max-w-5xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-4xl font-black text-slate-950 mb-6 italic uppercase tracking-tight">How it all started</h2>
          ...
          <div className="bg-emerald-950/5 rounded-[3rem] p-12 flex items-center justify-center">
             <div className="grid grid-cols-2 gap-4">
                <div className="bg-white p-8 rounded-[2rem] shadow-xl shadow-emerald-900/5 text-center">
                  <p className="text-4xl font-black text-emerald-600 mb-2 italic">2024</p>
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Founded</p>
                </div>
                <div className="bg-emerald-600 p-8 rounded-[2rem] shadow-xl shadow-emerald-900/20 text-center text-white translate-y-8">
                  <p className="text-4xl font-black mb-2 italic">5k+</p>
      ...
      <section className="bg-slate-900 py-24 px-6">
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black text-white italic uppercase tracking-tighter mb-4">Our Core Values</h2>
          <p className="text-slate-400 font-medium text-lg">The principles that guide everything we build.</p>
        </div>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto text-center">
        ...
        <h2 className="text-4xl md:text-6xl font-black text-slate-950 mb-12 italic uppercase tracking-tighter max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
           {[
             ...
             <div key={i} className="p-8 border border-gray-100 rounded-[2.5rem]">
